...
const segments = [
  ...
  { type: "word",   text: "but if you missed any text you want to go back to,", hold: true },
  { type: "word",   text: "just close your eyes for a few seconds and we'll rewind a bit.", end: true },
  { type: "phrase", text: "But yeah,", hold: true },
  { type: "word",   text: "by now you've blinked quite a few times, what really is blinking?", end: true },
  ...
  { type: "phrase",   text: "Age also affects blink rates.", hold:true },
  { type: "phrase",   text: "Infants blink much less, roughly one or two times per minute,", hold:true },
  { type: "phrase",   text: "probably because their eyes are small and well lubricated.", end:true },
  { type: "word",   text: "Well that was a lot of blinks you've blinked, but not so much when you compare it to the amount you blink every day.", end:true },
  { type: "word",   text: "Assuming you are well rested (aka well rested, aka not a RISD Student), and blink at an average rate of 15 blinks per minute over 16 waking hours,", end:true },
  ...
  { type: "word",   text: "that's 14,400 blinks/day × 0.25 seconds = 3,600 seconds/day = 1 hour/day you spend with your eyes closed simply from blinking", end:true },
  ...
  { type: "word",   text: "That's 4.16% of your entire life. Make of that what you will, but I think that's quite a long time spent blinking.", end:true },
  { type: "word",   text: "That was just time time our eyes close from blinking, what about the time we spend in total eyes closed. ", end:true },
  ...
  { type: "word",   text: "Thank you for blinking", end:true },
];
