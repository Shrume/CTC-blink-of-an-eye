...
const segments = [
  ...
  { type: "word",   text: "the duration of a blink is fairly consistent at around 0.1 to 0.4 seconds.", hold:true },
  ...
  { type: "word",   text: "Infants blink much less, roughly one or two times per minute,", hold:true },
  { type: "word",   text: "probably because their eyes are small and well lubricated.", end:true },
  { type: "word",   text: "Well that was quite a few blinks you've blinked, but not so much when you compare it to the amount you blink every day.", end:true },
